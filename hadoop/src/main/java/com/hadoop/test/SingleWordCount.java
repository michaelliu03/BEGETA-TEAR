...
/**
 *
 * {<a href='http://www.oschina.net/code/snippet_572882_11329'>@link</a>}
 *
 * windows 下运行hadoop job时报错：windows hadoop HDFS Failed to set permissions of path
 * 项目引用的 hadoop-core-1.0.2.jar  换成 hadoop-core-0.20.2.jar
 */
public class SingleWordCount {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String[] str = {"/hadoop/input.txt", "/hadoop/output/","torres"};
